...
mod tests {
    ...
    #[test]
    fn misc_fib() {
        assert_eq!(run_io(MISC_FIB, &[5]), IntcodeResult::Output(120));
        assert_eq!(run_io(MISC_FIB, &[10]), IntcodeResult::Output(3628800));
        assert_eq!(run_io(MISC_FIB, &[16]), IntcodeResult::Output(20922789888000));
        assert_eq!(run_io(MISC_FIB, &[18]), IntcodeResult::Output(6402373705728000));
    }
}